...
export const PRODUCT_DB_CONFIG = {
  motor: {
    ...
    detailTitle: "모터 상세",
    searchPlaceholder: "제조사·시리즈·모델명·모터종류 검색",
  ...
  reducer: {
    ...
    detailTitle: "감속기 상세",
    searchPlaceholder: "제조사·시리즈·모델명·감속기종류 검색",
  ...
  ballScrew: {
    ...
    detailTitle: "볼스크류 상세",
    searchPlaceholder: "제조사·시리즈·모델명·정밀등급 검색",
  ...
  electricActuator: {
    ...
    searchPlaceholder: "제조사·시리즈·모델명·액추에이터종류 검색",
  ...
  lmGuide: {
    ...
    searchPlaceholder: "제조사·시리즈·모델명·레일사이즈 검색",
  ...
  encoder: {
    ...
    detailTitle: "엔코더 상세",
    searchPlaceholder: "제조사·시리즈·모델명·엔코더종류 검색",
  ...
  vacuum: {
    ...
    detailTitle: "진공부품 상세",
    searchPlaceholder: "제조사·시리즈·모델명·부품종류 검색",
  ...
  vacuumPump: {
    ...
    detailTitle: "진공펌프 상세",
    searchPlaceholder: "제조사·시리즈·모델명·펌프종류 검색",
  ...
  vacuumValve: {
    ...
    detailTitle: "진공밸브 상세",
    searchPlaceholder: "제조사·시리즈·모델명·밸브종류 검색",
  ...
  vacuumMotion: {
    ...
    searchPlaceholder: "제조사·시리즈·모델명·모션종류 검색",
  ...
  vacuumGauge: {
    ...
    searchPlaceholder: "제조사·시리즈·모델명·게이지종류 검색",
